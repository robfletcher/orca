...
class RollbackServerGroupStage extends LinearStage {
  ...
  static enum RollbackType {
    ...
    RollbackType(Class implementationClass) {
  ...
  static class ExplicitRollback implements Rollback {
    ...
    List<Step> buildSteps(Stage stage) {
      ...
      enableServerGroupContext.asgName = restoreServerGroupName
      ...
      disableServerGroupContext.asgName = rollbackServerGroupName
